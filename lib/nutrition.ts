...
export function getFoodBadges(food: FoodItem): FoodBadge[] {
  ...
  if (food.protein >= 20)
    badges.push({
      label: "High Protein",
      cls: "bg-blue-100 text-blue-800 border border-blue-200 dark:bg-blue-900 dark:text-blue-300 dark:border-blue-700",
    });
  ...
  if (food.carbs <= 5 && food.calories > 0)
    badges.push({
      label: "Low Carb",
      cls: "bg-amber-100 text-amber-800 border border-amber-200 dark:bg-amber-900 dark:text-amber-300 dark:border-amber-700",
    });
  ...
  if (food.fiber >= 5)
    badges.push({
      label: "High Fiber",
      cls: "bg-emerald-100 text-emerald-800 border border-emerald-200 dark:bg-emerald-900 dark:text-emerald-300 dark:border-emerald-700",
    });
  ...
  if (food.calories <= 50 && food.calories > 0)
    badges.push({
      label: "Low Cal",
      cls: "bg-teal-100 text-teal-800 border border-teal-200 dark:bg-teal-900 dark:text-teal-300 dark:border-teal-700",
    });
  ...
  if (fatCalPct > 0.60 && food.carbs <= 10 && food.calories > 0)
    badges.push({
      label: "Keto",
      cls: "bg-purple-100 text-purple-800 border border-purple-200 dark:bg-purple-900 dark:text-purple-300 dark:border-purple-700",
    });
  ...
  if (netCarbs > 25 && food.fiber < 4)
    badges.push({
      label: "High Sugar",
      cls: "bg-rose-100 text-rose-800 border border-rose-200 dark:bg-rose-900 dark:text-rose-300 dark:border-rose-700",
    });
